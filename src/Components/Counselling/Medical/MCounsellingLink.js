...
function MCounsellingLink({college_logo, college_name,Intro,latest_news,news_event, apply_link}) {
    const navigate = useNavigate();
    const switchToApplyHomePage = () =>{
        navigate("/medicalapplyhome",{state:{id:1,intro:Intro,latest_news:latest_news,news_event:news_event,apply_link:apply_link}});
    }
    return (
        <div className='box-1'>
...
export default MCounsellingLink