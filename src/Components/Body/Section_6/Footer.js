          ...
          <div className="footer-content">
            <div className="footer-content-column">
              <div className="footer-logo">
                <a className="footer-logo-link" href="#">
                  ...
                  <h1 style={{fontFamily:"Poppins"}}>CareerBanao</h1>
                </a>
              </div>
            ...
            <div className="footer-content-column">
              <div className="footer-call-to-action">
                ...
                <Link to="/contact" className="footer-call-to-action-button button" href="#" target="_self"> Get in Touch </Link>
              </div>
              <div className="footer-call-to-action">
            ...
            <div className="footer-social-links"> <svg className="footer-social-amoeba-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 236 54">
              ...
              <a className="footer-social-link github" href="#" target="_blank">
                ...
                <svg className="footer-social-icon-svg git" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
